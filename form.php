...
<form action="?" method="get"> <!-- 等同form action="form.php" -->
...
<h5>你的BMI為</h5>
<div style="background:lightblue;width:200px;height:30px"><?=round($result,2);?></div>
<a href='student.php?num=<?=$_GET['num'];?>'>回學生查詢頁面</a><br>
